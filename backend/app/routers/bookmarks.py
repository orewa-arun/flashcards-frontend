...
async def load_flashcard_data(course_id: str, deck_id: str, flashcard_index: int) -> Optional[dict]:
    ...
    try:
        ...
        json_path = f"/Users/arunkumarmurugesan/Documents/entreprenuer-apps/self-learning-ai/frontend/public/courses/{course_id}/cognitive_flashcards/{deck_id}/{deck_id}_cognitive_flashcards.json"
